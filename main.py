...
class OTPMonitorBot:
    ...
    def fetch_sms_data(self):
        ...
        headers = {
            ...
            'referer': 'https://konektapremium.net/client/SMSCDRStats',
...
async def main():
    ...
    TELEGRAM_BOT_TOKEN = "8658949662:AAE1b0TZdiZDt0e23OAHL5LCpObS_aEzWO4"
    GROUP_CHAT_ID = "-1003796890472"
    SESSION_COOKIE = "439bb1dd523304b74e946f29cac0abde"  # Updated session cookie
    TARGET_HOST = "konektapremium.net"  # Updated host
    TARGET_URL = f"https://{TARGET_HOST}/client/res/data_smscdr.php"  # Updated URL with HTTPS
